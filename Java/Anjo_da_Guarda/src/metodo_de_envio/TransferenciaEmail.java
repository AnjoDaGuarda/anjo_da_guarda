...
public class TransferenciaEmail extends Metodo {
	 ...
	 */
	public TransferenciaEmail() { // Para o GMAIL
	...
	private void sendMail(String from, String to, String subject, String message) {
		...
		// usuario ou seja, a conta que esta enviando o email (tem que ser do
		// GMAIL)
		...
		SimpleAuth auth = new SimpleAuth(from, "&PCML24101721#");
		...
		// Habilita o LOG das ações executadas durante o
		// envio do email
		...
		try {
			 ...
			 * sua senha do gmail
			 */
			tr.connect(mailSMTPServer, from, "&PCML24101721#");
	...
	public void actionByString(String inputLine) {
		for (int i = 0; i < emails.size(); i++) {
			sendMail("anjodaguardateam@gmail.com", emails.get(i),
					"detecção do Anjo da Guarda",
					mapCausaConsequencia.get(inputLine));
		}
	}
